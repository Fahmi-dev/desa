...
class M_pertanahan extends CI_Model {
	...
	public function hapus_bengkok ($id_desa){
		$hasil=$this->db->query("DELETE FROM tb_tanah_bengkok WHERE id_desa='$id_desa'");
		return $hasil;
	}

	public function hapus_luas_wilayah ($id_desa){
		$hasil=$this->db->query("DELETE FROM tb_luas_wilayah WHERE id_desa='$id_desa'");
		return $hasil;
	}

	public function hapus_tanah_kering ($id_desa){
		$hasil=$this->db->query("DELETE FROM tb_luas_tanah_kering WHERE id_desa='$id_desa'");
		return $hasil;
	}

	public function hapus_tanah_sawah ($id_desa){
		$hasil=$this->db->query("DELETE FROM tb_luas_tanah_sawah WHERE id_desa='$id_desa'");
		return $hasil;
	}
