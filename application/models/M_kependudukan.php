...
// }
	...
	public function hapus_kependudukan ($id_desa){
		$hasil=$this->db->query("DELETE FROM tb_kependudukan WHERE id_desa='$id_desa'");
		return $hasil;
	}

	public function hapus_mutasi ($id_desa){
		$hasil=$this->db->query("DELETE FROM tb_mutasi_kependudukan WHERE id_desa='$id_desa'");
		return $hasil;
	}
