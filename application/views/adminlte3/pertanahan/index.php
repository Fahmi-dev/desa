                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="text-align: center;">
                       <a class="btn btn-warning btn-sm" href="<?php echo base_url() ?>admin/pertanahan/edit_bengkok/<?php echo $dataTanahbengkok->id_desa ?>">Edit</a>
                       <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>admin/pertanahan/hapus_bengkok/<?php echo $dataTanahbengkok->id_desa ?>" onclick="return confirm('Yakin ingin menghapus?')" >Delete</a>
                     </td>
                   <?php endforeach ?>
                 </tbody>
               </table>
              ...
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                  <tr class="text-black">
                    ...
                    <th style="text-align: center;">Id Desa</th>
                    <th style="text-align: center;">Nama Desa</th>
                    <th style="text-align: center;" id="demo">Luas Wilayah</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="text-align: center;">
                      <a class="btn btn-warning btn-sm" href="<?php echo base_url() ?>admin/pertanahan/edit_luas/<?php echo $dataLuaswilayah->id_desa ?>">Edit</a>
                      <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>admin/pertanahan/hapus_luas_wilayah/<?php echo $dataLuaswilayah->id_desa ?>" onclick="return confirm('Yakin ingin menghapus?')" >Delete</a>
                    </td>
                  <?php endforeach ?>
                </tbody>
              </table>
              ...
              <table id="example3" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="text-align: center;">
                      <a class="btn btn-warning btn-sm" href="<?php echo base_url() ?>admin/pertanahan/edit_kering/<?php echo $dataTanahkering->id_desa ?>">Edit</a>
                      <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>admin/pertanahan/hapus_tanah_kering/<?php echo $dataTanahkering->id_desa ?>" onclick="return confirm('Yakin ingin menghapus?')" >Delete</a>
                    </td>
                  <?php endforeach ?>
                </tbody>
              </table>
              ...
              <table id="example4" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="text-align: center;">
                      <a class="btn btn-warning btn-sm" href="<?php echo base_url() ?>admin/pertanahan/edit_sawah/<?php echo $dataTanahsawah->id_desa ?>">Edit</a>
                      <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>admin/pertanahan/hapus_tanah_sawah/<?php echo $dataTanahsawah->id_desa ?>" onclick="return confirm('Yakin ingin menghapus?')" >Delete</a>
                    </td>
                  <?php endforeach ?>
                </tbody>
              </table>
