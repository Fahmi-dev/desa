              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="text-align: center;">
                    <a class="btn btn-warning btn-sm" href="<?php echo base_url() ?>admin/kependudukan/edit_kependudukan/<?php echo $dataKependudukan->id_desa ?>">Edit</a>
                    <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>admin/kependudukan/hapus_kependudukan/<?php echo $dataKependudukan->id_desa ?>" onclick="return confirm('Yakin ingin menghapus?')" >Delete</a>
                  </td>
                <?php endforeach ?>
              </tbody>
            </table>
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="text-align: center;">
                    <a class="btn btn-warning btn-sm" href="<?php echo base_url() ?>admin/kependudukan/edit_umur/<?php echo $dataKependudukan_umur->id_desa ?>">Edit</a>
                      <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>admin/kependudukan/hapus_kep_umur/<?php echo $dataKependudukan_umur->id_desa ?>" onclick="return confirm('Yakin ingin menghapus?')" >Delete</a>
              ...
              <table id="example3" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="text-align: center;">
                     <a class="btn btn-warning btn-sm" href="<?php echo base_url() ?>admin/kependudukan/edit_mutasi/<?php echo $dataMutasi->id_desa ?>">Edit</a>
                        <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>admin/kependudukan/hapus_mutasi/<?php echo $dataMutasi->id_desa ?>" onclick="return confirm('Yakin ingin menghapus?')" >Delete</a>
