            ...
            <table id="example2" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="text-align: center;"><?php echo $datapln_pdam-> id_desa; ?></td>
                  ...
                  <td style="text-align: center;">
                     <a class="btn btn-warning btn-sm" href="<?php echo base_url() ?>admin/pln_pdam/edit_plnpdam/<?php echo $datapln_pdam->id_desa ?>">Edit</a>
                      <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>admin/pln_pdam/hapus_plnpdam/<?php echo $datapln_pdam->id_desa ?>" onclick="return confirm('Yakin ingin menghapus?')" >Delete</a>
                      </td>
                    <?php endforeach ?>
                  </tbody>
                </table>
