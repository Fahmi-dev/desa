                ...
                <table id="example3" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="text-align: center;"><?php echo $dataUser -> id_user; ?></td>
                      ...
                      <td style="text-align: center;">
                        <a class="btn btn-warning btn-sm" href="<?php echo base_url() ?>admin/user/edit_user/<?php echo $dataUser->id_user ?>">Edit</a>
                          <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>admin/user/hapus_user/<?php echo $dataUser->id_user ?>" onclick="return confirm('Yakin ingin menghapus?')" >Delete</a>
                        </td>
                      <?php endforeach ?>
                    </tbody>
