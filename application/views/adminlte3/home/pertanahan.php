        ...
        <table id="example2" class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align: center;"><?php echo $dataTanahbengkok -> id_desa; ?></td>
              ...
              <td style="text-align: center;">
                  <a class="btn btn-warning btn-sm" href="<?php echo base_url() ?>staf/pertanahan/edit_bengkok/<?php echo $dataTanahbengkok->id_desa ?>">Edit</a>
                  <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>staf/pertanahan/hapus_bengkok/<?php echo $dataTanahbengkok->id_desa ?>" onclick="return confirm('Yakin ingin menghapus?')" >Delete</a>
                </td>
              <?php endforeach ?>
            </tbody>
          </table>
        ...
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align: center;">
                  <a class="btn btn-warning btn-sm" href="<?php echo base_url() ?>staf/pertanahan/edit_luas/<?php echo $dataLuaswilayah->id_desa ?>">Edit</a>
                  <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>staf/pertanahan/hapus_luas_wilayah/<?php echo $dataLuaswilayah->id_desa ?>" onclick="return confirm('Yakin ingin menghapus?')" >Delete</a>
                </td>
              <?php endforeach ?>
            </tbody>
          </table>
        ...
        <table id="example3" class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align: center;">
               <a class="btn btn-warning btn-sm" href="<?php echo base_url() ?>staf/pertanahan/edit_kering/<?php echo $dataTanahkering->id_desa ?>">Edit</a>
                  <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>staf/pertanahan/hapus_tanah_kering/<?php echo $dataTanahkering->id_desa ?>" onclick="return confirm('Yakin ingin menghapus?')" >Delete</a>
                </td>
              <?php endforeach ?>
            </tbody>
          </table>
          ...
          <table id="example4" class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="text-align: center;">
                 <a class="btn btn-warning btn-sm" href="<?php echo base_url() ?>staf/pertanahan/edit_sawah/<?php echo $dataTanahsawah->id_desa ?>">Edit</a>
                    <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>staf/pertanahan/hapus_tanah_sawah/<?php echo $dataTanahsawah->id_desa ?>" onclick="return confirm('Yakin ingin menghapus?')" >Delete</a>
                  </td>
                <?php endforeach ?>
              </tbody>
            </table>
    ...
    <div class="modal-content">
      ...
      <form class="form-horizontal" action="<?php echo base_url('staf/pertanahan/tambah_aksi')?>" method="post" enctype="multipart/form-data" role="form">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-12">
            <input type="number" class="form-control" name="bengkok_sawah" placeholder="Masukan Bengkok Sawah" required>
          </div>
        </div>
        <div class="form-group">
          <label class="col-lg-6 col-sm-2 control-label" for="username" style="color: #0f3975">Bengkok Lahan Kering</label>
          <div class="col-lg-12">
            <input type="number" class="form-control" name="bengkok_lahan_kering" placeholder="Masukan Bengkok Lahan Kering" required>
          </div>
        </div>
        <div class="form-group">
          <label class="col-lg-6 col-sm-2 control-label" for="username" style="color: #0f3975">Kas Sawah</label>
          <div class="col-lg-12">
            <input type="number" class="form-control" name="kas_sawah" placeholder="Masukan Kas Sawah" required>
          </div>
        </div>
        <div class="form-group">
          <label class="col-lg-6 col-sm-2 control-label" for="username" style="color: #0f3975">Kas Lahan Kering</label>
          <div class="col-lg-12">
            <input type="number" class="form-control" name="kas_lahan_kering" placeholder="Masukan Kas Lahan Kering" required>
          </div>
        </div>
        <div class="form-group">
    ...
    <div class="modal-content">
      ...
      <form class="form-horizontal" action="<?php echo base_url('staf/pertanahan/tambah_aksi_luas')?>" method="post" enctype="multipart/form-data" role="form">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-12">
            <input type="number" class="form-control" name="luas_wilayah" placeholder="Masukan Luas Wilayah" required>
          </div>
        </div>
        <div class="form-group">
    ...
    <div class="modal-content">
      ...
      <form class="form-horizontal" action="<?php echo base_url('staf/pertanahan/tambah_aksi_kering')?>" method="post" enctype="multipart/form-data" role="form">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-12">
            <input type="number" class="form-control" name="perkarangan_bangunan" placeholder="Masukan Luas Pekaranga Bangunan" required>
          </div>
        </div>
        <div class="form-group">
          <label class="col-lg-6 col-sm-2 control-label" for="username" style="color: #0f3975">Luas Kebun</label>
          <div class="col-lg-12">
            <input type="number" class="form-control" name="tegal_kebun" placeholder="Masukan Luas Kebun" required>
          </div>
        </div>
        <div class="form-group">
          <label class="col-lg-6 col-sm-2 control-label" for="username" style="color: #0f3975">Luas Padang Gembala</label>
          <div class="col-lg-12">
            <input type="number" class="form-control" name="padang_gembala" placeholder="Masukan Luas Padang Gembala" required>
          </div>
        </div>
        <div class="form-group">
          <label class="col-lg-6 col-sm-2 control-label" for="username" style="color: #0f3975">Luas Tambak Kolam</label>
          <div class="col-lg-12">
            <input type="number" class="form-control" name="tambak_kolam" placeholder="Masukan Luas Tambak Kolam" required>
          </div>
        </div>
        <div class="form-group">
          <label class="col-lg-6 col-sm-2 control-label" for="username" style="color: #0f3975">Luas Hutan Negara</label>
          <div class="col-lg-12">
            <input type="number" class="form-control" name="hutan_negara" placeholder="Masukan Luas Hutan Negara" required>
          </div>
        </div>
        <div class="form-group">
          <label class="col-lg-6 col-sm-2 control-label" for="username" style="color: #0f3975">Luas Perkebunan Negara</label>
          <div class="col-lg-12">
            <input type="number" class="form-control" name="perkebunan_negara" placeholder="Masukan Luas Perkebunan Negara" required>
          </div>
        </div>
        <div class="form-group">
          <label class="col-lg-6 col-sm-2 control-label" for="username" style="color: #0f3975">Luas Lainnya</label>
          <div class="col-lg-12">
            <input type="number" class="form-control" name="lainnya" placeholder="Masukan Luas Lainnya" required>
          </div>
        </div>
        <div class="form-group">
    ...
    <div class="modal-content">
      ...
      <form class="form-horizontal" action="<?php echo base_url('staf/pertanahan/tambah_aksi_sawah')?>" method="post" enctype="multipart/form-data" role="form">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-12">
            <input type="number" class="form-control" name="irigasi_teknis" placeholder="Masukan Luas Irigasi Teknis" required>
          </div>
        </div>
        <div class="form-group">
          <label class="col-lg-6 col-sm-2 control-label" for="username" style="color: #0f3975">Luas Irigasi Setengah Teknis</label>
          <div class="col-lg-12">
            <input type="number" class="form-control" name="irigasi_setengah_teknis" placeholder="Masukan Luas Irigasi Setengah Teknis" required>
          </div>
        </div>
        <div class="form-group">
          <label class="col-lg-6 col-sm-2 control-label" for="username" style="color: #0f3975">Luas Irigasi Sederhana</label>
          <div class="col-lg-12">
            <input type="number" class="form-control" name="irigasi_sederhana" placeholder="Masukan Luas Irigasi Sederhana" required>
          </div>
        </div>
        <div class="form-group">
          <label class="col-lg-6 col-sm-2 control-label" for="username" style="color: #0f3975">Luas Hujan Tadah</label>
          <div class="col-lg-12">
            <input type="number" class="form-control" name="hujan_tadah" placeholder="Masukan Luas Hujan Tadah" required>
          </div>
        </div>
         <div class="form-group">
          <label class="col-lg-6 col-sm-2 control-label" for="username" style="color: #0f3975">Jumlah</label>
