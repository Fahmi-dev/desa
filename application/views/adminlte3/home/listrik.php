              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="text-align: center;">
                   <a class="btn btn-warning btn-sm" href="<?php echo base_url() ?>staf/listrik/edit_plnpdam/<?php echo $datapln_pdam->id_desa ?>">Edit</a>
                       <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>staf/listrik/hapus_plnpdam/<?php echo $datapln_pdam->id_desa ?>" onclick="return confirm('Yakin ingin menghapus?')" >Delete</a>
                      </td>
                    <?php endforeach ?>
                  </tbody>
                </table>
